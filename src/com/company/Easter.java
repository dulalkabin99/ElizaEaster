...
public class Easter {
    ...
    public static String getResponse(String s1) {
        String message = "";
    ...
    public static String getLatinResponse(String s1) {
        String rMessage = "";
        //split only ino array
        String[] que = s1.split(" ");

        //variable to change the string to pig lating
        String[] rejoin = new String[que.length];
